...
studentPD.get('/', (request, response) => {
...
studentPD.get("/students", (request, response) => {
  response.json(studentData);
});

//proof of concept can search by score for focus heading
studentPD.get("/students/focus/:score", (request, response) => {
...
studentPD.get("/students/search", (request, response) => {
...
studentPD.get("/students/:id", (request, response) => {
